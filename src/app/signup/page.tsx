      ...
      >
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-slate-500 dark:text-slate-400 text-center text-sm px-6">
            Join thousands of professionals and start learning today.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <input
              ...
              required
              className="w-full px-5 py-3 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-slate-900 dark:text-white transition-all"
            />
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-center text-sm text-slate-500 mt-6">
              Already have an account? <Link href="/login" className="text-blue-500 hover:text-blue-600 font-bold transition-colors">Log In</Link>
            </p>
          </div>
        </form>
      </motion.div>
