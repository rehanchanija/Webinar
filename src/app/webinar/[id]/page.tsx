...
export default function WebinarDetailPage() {
  ...
  const enrollment = user
    ? enrollments.find((e) => e.webinarId === webinarId && e.userId === user.id)
    : null;
          ...
          <div className="flex-1 glass rounded-[40px] flex flex-col overflow-hidden shadow-2xl shadow-blue-500/5">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 scrollbar-hide">
              {[
                {
                  user: "Sarah J.",
                  text: "This intro is amazing! So excited for this session.",
                  color: "text-pink-500",
                },
                {
                  user: "Mike Chen",
                  text: "Will there be a recording available afterwards?",
                  color: "text-blue-500",
                },
                {
                  user: "Alex Rivera",
                  text: "I started using these techniques last week. Major difference.",
                  color: "text-amber-500",
                },
                {
                  user: "Emily Watson",
                  text: "The designer perspective on this is super helpful.",
                  color: "text-green-500",
                },
                {
                  user: "Host",
                  text: "Welcome everyone! We will be starting in 2 minutes.",
                  color: "text-blue-600 font-black italic",
                },
              ].map((msg, i) => (
                <div key={i} className="flex flex-col gap-1 group">
                  <span
                    className={cn(
                      "text-xs font-black uppercase tracking-tighter opacity-70",
                      msg.color,
                    )}
                  >
                    {msg.user}
